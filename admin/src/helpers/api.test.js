...
describe('api', () => {
  ...
  test('login: fail', async () => {
    ...
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/login')
  ...
  test('fetchCurrentUser: fail', async () => {
    ...
    expect(fetch.mock.calls.length).toEqual(1)
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/api/status')
  ...
  test('fetchUsers', async () => {
    ...
    expect(fetch.mock.calls.length).toEqual(1)
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/api/users')
  ...
  test('updatePassword', async () => {
    ...
    expect(fetch.mock.calls.length).toEqual(1)
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/api/account')
  ...
  test('deleteUser', async () => {
    ...
    expect(fetch.mock.calls.length).toEqual(1)
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/api/users/abc123')
    expect(success).toBe(true)
  })
  ...
  test('postCheckpoints', async () => {
    ...
    expect(fetch.mock.calls.length).toEqual(1)
    expect(fetch.mock.calls[0][0]).toEqual('https://track-covid-19-gambia.herokuapp.com/admin/api/checkpoints')
    expect(success).toBe(true)
  })
})
